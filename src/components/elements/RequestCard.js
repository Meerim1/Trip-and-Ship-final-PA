...
class RequestCard extends Component {
  render() {
    const { id, startPoint, endPoint, date, item, classes } = this.props;

    return (
      <SCard key={id} xs="4">
        <Link to="/oneRequest">
          <SCardHeader>User Name</SCardHeader>
          <SCardBody>
            <SFlexDiv column>
              <LocacionDiv>
...
RequestCard.propTypes = {
  ...
  startPoint: PT.string.isRequired,
  endPoint: PT.string.isRequired,
  item: PT.array.isRequired,
